...
export const MOCK_CONVERSATIONS: WaConversation[] = [
  {
    ...
    notes: null,
    guest_language: 'es',
    last_customer_message_at: minsAgo(4),
  ...
  },
  {
    ...
    notes: null,
    guest_language: 'en',
    last_customer_message_at: minsAgo(22),
  ...
  },
  {
    ...
    notes: null,
    guest_language: 'es',
    last_customer_message_at: minsAgo(55),
  ...
  },
  {
    ...
    notes: null,
    guest_language: 'en',
    last_customer_message_at: minsAgo(180),
  ...
  },
  {
    ...
    notes: null,
    guest_language: 'es',
    last_customer_message_at: daysAgo(3),
  ...
  'conv-1': [
    {
      ...
      role: 'inbound', content: 'Hola! Vi su posada en internet y me interesa reservar para diciembre.', content_en: 'Hello! I saw your posada online and I\'m interested in booking for December.', content_es: null,
    ...
    },
    {
      ...
      role: 'outbound', content: '¡Hola María! Bienvenida 🌴 Tenemos disponibilidad en diciembre. ¿Para cuántas noches y cuántas personas?', content_en: null, content_es: null,
    ...
    },
    {
      ...
      role: 'inbound', content: 'Para 5 noches, del 20 al 25 de diciembre. Somos 2 adultos y 1 niño.', content_en: 'For 5 nights, December 20–25. We are 2 adults and 1 child.', content_es: null,
    ...
    },
    {
      ...
      role: 'outbound', content: 'Perfecto! Para esas fechas, la Habitación Doble Deluxe está disponible. El precio es $180/noche, total $900 para 5 noches. Incluye desayuno criollo para todos.', content_en: null, content_es: null,
      detected_lang: null, is_ai: true, flagged: false, flag_reason: null, sentiment_score: null, created_at: daysAgo(2),
    },
    {
      id: 'm1-5', conversation_id: 'conv-1', wa_message_id: null,
      role: 'inbound', content: 'Okay me parece bien. ¿Cómo hago el pago?', content_en: 'Okay that sounds good. How do I make the payment?', content_es: null,
    ...
    },
    {
      ...
      role: 'outbound', content: 'Aceptamos transferencia Zelle a pagos@posada.com o pago en efectivo USD al llegar. Para confirmar, pedimos 30% de depósito ($270).', content_en: null, content_es: null,
    ...
    },
    {
      ...
      role: 'inbound', content: 'No entiendo por qué el precio cambió! Antes decía $150 la noche en la página web', content_en: 'I don\'t understand why the price changed! Before it said $150/night on the webpage', content_es: null,
  ...
  'conv-2': [
    {
      ...
      role: 'inbound', content: 'Hi! I booked 3 nights starting tomorrow. Just confirming everything is set?', content_en: null, content_es: '¡Hola! Reservé 3 noches a partir de mañana. ¿Confirmo que todo está listo?',
    ...
    },
    {
      ...
      role: 'outbound', content: 'Hi James! Yes, all confirmed for tomorrow. Your room (Suite 2) is ready. Check-in is from 2pm. Do you need airport pickup?', content_en: null, content_es: '¡Hola James! Sí, todo confirmado para mañana. Tu habitación (Suite 2) está lista. El check-in es a partir de las 2pm. ¿Necesitas transporte del aeropuerto?',
    ...
    },
    {
      ...
      role: 'inbound', content: 'That\'d be great actually. We land at 1pm at Maiquetia.', content_en: null, content_es: 'Eso sería genial. Llegamos a la 1pm a Maiquetía.',
    ...
    },
    {
      ...
      role: 'outbound', content: 'I\'ll arrange that for you. Our driver Carlos will be at arrivals with a sign. The transfer is $45. I\'ll send his WhatsApp number shortly.', content_en: null, content_es: 'Lo organizo para ti. Nuestro conductor Carlos estará en llegadas con un cartel. El traslado es $45. Te enviaré su número de WhatsApp pronto.',
    ...
    },
    {
      ...
      role: 'inbound', content: 'Sounds good. Do you have a pool?', content_en: null, content_es: 'Suena bien. ¿Tienen piscina?',
    ...
    },
    {
      ...
      role: 'outbound', content: 'Yes! Heated pool open 7am–10pm, plus a jacuzzi. Towels provided. We also have a bar by the pool 🍹', content_en: null, content_es: '¡Sí! Piscina climatizada abierta de 7am a 10pm, más jacuzzi. Toallas incluidas. También tenemos un bar junto a la piscina 🍹',
    ...
    },
    {
      ...
      role: 'inbound', content: 'Perfect, we\'ll arrive around 3pm then', content_en: null, content_es: 'Perfecto, llegaremos alrededor de las 3pm entonces',
  ...
  'conv-3': [
    {
      ...
      role: 'inbound', content: 'Buenas tardes, ¿tienen habitaciones disponibles para enero?', content_en: 'Good afternoon, do you have rooms available for January?', content_es: null,
    ...
    },
    {
      ...
      role: 'outbound', content: '¡Buenas tardes Carlos! Sí, tenemos disponibilidad en enero. ¿Qué fechas tiene en mente y cuántas personas serían?', content_en: null, content_es: null,
    ...
    },
    {
      ...
      role: 'inbound', content: 'Del 10 al 15 de enero, 2 personas. ¿Cuánto costaría?', content_en: 'From January 10 to 15, 2 people. How much would it cost?', content_es: null,
      detected_lang: 'es', is_ai: false, flagged: false, flag_reason: null, sentiment_score: 0.85, created_at: daysAgo(1),
    },
    {
      id: 'm3-4', conversation_id: 'conv-3', wa_message_id: null,
      role: 'outbound', content: 'Para esas fechas, la Habitación Estándar Doble está a $120/noche. Por 5 noches serían $600, desayuno incluido. También tenemos Suite Deluxe a $160/noche si prefieren más espacio.', content_en: null, content_es: null,
      detected_lang: null, is_ai: true, flagged: false, flag_reason: null, sentiment_score: null, created_at: daysAgo(1),
    },
    {
      id: 'm3-5', conversation_id: 'conv-3', wa_message_id: null,
      role: 'inbound', content: 'Muchas gracias por la información', content_en: 'Thank you very much for the information', content_es: null,
  ...
  'conv-4': [
    {
      ...
      role: 'inbound', content: 'Hello! Do you have availability for 4 nights in February?', content_en: null, content_es: '¡Hola! ¿Tienen disponibilidad para 4 noches en febrero?',
    ...
    },
    {
      ...
      role: 'outbound', content: 'Hi Sophie! Welcome 🌴 Yes, February is available. Which dates were you thinking? We have lovely rooms with garden or pool views.', content_en: null, content_es: '¡Hola Sophie! Bienvenida 🌴 Sí, febrero está disponible. ¿Qué fechas estás pensando? Tenemos habitaciones con vista al jardín o la piscina.',
    ...
    },
    {
      ...
      role: 'inbound', content: 'Do you have availability for 4 nights?', content_en: null, content_es: '¿Tienen disponibilidad para 4 noches?',
  ...
  'conv-5': [
    {
      ...
      role: 'inbound', content: 'Quiero reservar 3 noches para noviembre', content_en: 'I want to book 3 nights in November', content_es: null,
    ...
    },
    {
      ...
      role: 'outbound', content: '¡Hola! Con gusto. Tenemos la Habitación Estándar disponible. ¿Qué fechas exactas?', content_en: null, content_es: null,
    ...
    },
    {
      ...
      role: 'inbound', content: 'Del 5 al 8. Perfecto. Procedo con el pago.', content_en: 'From the 5th to the 8th. Perfect. I\'ll proceed with payment.', content_es: null,
    ...
    },
    {
      ...
      role: 'outbound', content: 'Confirmado ✅ Les esperamos del 5 al 8 de noviembre. Recibirán instrucciones de llegada pronto.', content_en: null, content_es: null,
    ...
    },
    {
      ...
      role: 'inbound', content: 'Gracias, estuvo todo perfecto', content_en: 'Thank you, everything was perfect', content_es: null,
