      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-8 flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-500 capitalize">{listing.type} · {listing.region}</p>
            {listing.avg_rating && (
        ...
        {/* Benefits */}
        <h2 className="text-xl font-bold text-gray-900 mb-5">What you get as a platform partner</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          {benefits.map((b) => (
            <div key={b.title} className="bg-white rounded-xl border border-gray-100 p-4 flex gap-3">
        ...
        <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200 rounded-2xl p-6 mb-8 text-center">
          <div className="text-3xl mb-2">🏆</div>
          <h3 className="font-bold text-amber-900 text-lg mb-1">Founding Partner Offer</h3>
          <p className="text-amber-800 text-sm">
            The first 50 businesses to join get <strong>permanent Founding Partner status</strong> —
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-gray-400">
            ...
            <Link href={`/listing/${listing.slug}`} className="text-blue-600 hover:underline">
              here
            </Link>
          </p>
        </div>
