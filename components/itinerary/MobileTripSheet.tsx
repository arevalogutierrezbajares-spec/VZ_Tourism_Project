  ...
  return (
    <Drawer.Root>
      ...
      <Drawer.Trigger asChild>
        <button
          ...
          className={cn(
            ...
            'text-sm font-medium hover:shadow-xl transition-shadow cursor-pointer',
            'md:hidden',
            className
          )}
        >
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed bottom-0 left-0 right-0 z-50 bg-background rounded-t-2xl max-h-[85vh] flex flex-col" aria-label="Trip preview">
          {/* Handle */}
          ...
          <div className="px-4 pb-3 border-b">
            <Drawer.Title className="font-semibold text-base">Your Trip</Drawer.Title>
